#!/bin/bash
set -x
export PROJECT_ROOT=/share/project/tangning/MMGraph
export PYTHONPATH=${PROJECT_ROOT}:${PYTHONPATH}
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
PROJECT_NAME="verl_vagen"
EXPERIMENT_NAME="ppo_mmkg_no_concat_${TIMESTAMP}"
...
DATASET_TRAIN=${SCRIPTDIR}/train_mmkg_vision.yaml
DATASET_VAL=${SCRIPTDIR}/val_mmkg_vision.yaml
...
#export RENDER_WS_URL=xxx
# Use KL loss for shifting 
